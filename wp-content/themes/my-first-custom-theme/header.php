...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo bloginfo('template_directory'); ?>/images/favicon.png" type="">
  ...
  <div class="hero_area">
    ...
    <div class="hero_bg_box">
      <div class="bg_img_box">
        <img src="<?php echo bloginfo('template_directory'); ?>/images/hero-bg.png" alt="">
      </div>
    </div>
